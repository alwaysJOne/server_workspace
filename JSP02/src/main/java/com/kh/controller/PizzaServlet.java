...
public class PizzaServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// request.getParamterValues("키") : ["벨류값", "벨류값" ...] (String [])
		...
		String[] sides = request.getParameterValues("side"); // ["콜라", "사이다"] | null
		String payment = request.getParameter("payment"); // 현금
		...
		// 단, 응답페이지에 필요한 데이터가 있다면 담아서 포워딩 할것
